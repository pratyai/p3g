...
(assert (forall ((kfdia Int) (kidia Int) (klev Int) (klon Int) (ncldtop Int) (tmp_parfor_53 Int))
  (=>
    (and
      (not (or (and (= tmp_parfor_53 (+ tmp_parfor_53 1)) (= _for_it_103 _for_it_104)) (= tmp_parfor_53 (+ tmp_parfor_53 1)) (and (= tmp_parfor_53 (+ tmp_parfor_53 1)) (= _for_it_104 _for_it_103))))
      (<= kidia (+ kfdia (- 1)))
      (<= ncldtop (+ klev (- 1)))
