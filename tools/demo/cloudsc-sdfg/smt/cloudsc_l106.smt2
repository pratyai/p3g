...
(assert (forall ((_for_it_59 Int) (kfdia Int) (kidia Int) (klev Int) (klon Int) (ncldtop Int))
  (=>
    (and
      (not (or (and (= 0 (+ (select jn_val (- (+ _for_it_23 1) ncldtop)) (- 1))) (= (+ (select jn_val (- (+ _for_it_23 1) ncldtop)) (- 1)) 0) (= _for_it_59 (+ _for_it_59 1)) (= (select _if_cond_70_val (- (+ (* (- (+ _for_it_23 1) ncldtop) (- kfdia kidia)) _for_it_59 1) kidia)) 1) (= (select _if_cond_70_val (- (+ (* (- (+ _for_it_23 1) ncldtop) (- kfdia kidia)) _for_it_59 2) kidia)) 1)) (and (= (select _if_cond_70_val (- (+ (* (- (+ _for_it_23 1) ncldtop) (- kfdia kidia)) _for_it_59 2) kidia)) 1) (= (select _if_cond_70_val (- (+ (* (- (+ _for_it_23 1) ncldtop) (- kfdia kidia)) _for_it_59 1) kidia)) 1) (= _for_it_59 (+ _for_it_59 1))) (= (- (+ (* (- (+ _for_it_23 1) ncldtop) (- kfdia kidia)) _for_it_59 1) kidia) (- (+ (* (- (+ _for_it_23 1) ncldtop) (- kfdia kidia)) _for_it_59 2) kidia)) (and (= (select _if_cond_70_val (- (+ (* (- (+ _for_it_23 1) ncldtop) (- kfdia kidia)) _for_it_59 2) kidia)) 1) (= (select _if_cond_70_val (- (+ (* (- (+ _for_it_23 1) ncldtop) (- kfdia kidia)) _for_it_59 1) kidia)) 1))))
      (<= kidia (+ kfdia (- 1)))
      (<= ncldtop (+ klev (- 1)))
